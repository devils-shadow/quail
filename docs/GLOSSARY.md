...
- **Quail 2.0 (Planned):** A future scope that may introduce authenticated user roles, tenant inboxes, and public inbox access restrictions. This would revise the shared inbox model; see `docs/QUAIL_2_0_SPEC.md`.
