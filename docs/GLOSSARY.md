...
- **Postfix:** The mail transfer agent that receives inbound SMTP messages for the `m.cst.ro` domain and hands them off to the ingest script【104907567664902†L42-L47】.
